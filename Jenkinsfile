            ...
            steps {
                script {
                    ...
                    withSonarQubeEnv(credentialsId: 'c191d43f-0199-4f04-95a1-3afe1cd9803e', installationName: 'SonarQube Scanner') {
                        ...
                        bat "\"${env.MAVEN_PATH}\" dependency:purge-local-repository"
                        bat "\"${env.MAVEN_PATH}\" -U -Djavax.net.ssl.trustStore=src\\test\\jobs\\test.jks -Djavax.net.ssl.trustStorePassword=123456789 sonar:sonar"
